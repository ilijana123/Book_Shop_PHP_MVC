...
switch ($action) {
    ...
    case 'edit_product':
        ...
        function handle_image_upload($image) {
            ...
            // Check file size
            if ($image['size'] > 5000000) { // Adjust this size limit as per your requirements
                echo "File size is too large. Maximum file size allowed is 5MB.";
                exit;
            }
            ...
            if (move_uploaded_file($image['tmp_name'], $image_path)) {
                return $image_path; // Return the file path if successful
            } else {
                echo "Error moving uploaded file.";
                exit;
            }
