...
require_once 'path_to_your_functions/account_db.php'; // Include the file where is_valid_admin_login is defined
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav mb-2 mb-lg-0">
                    ...
                    <?php if(is_valid_admin_login($username,$email,$password)): ?>
                        <li class="nav-item">
