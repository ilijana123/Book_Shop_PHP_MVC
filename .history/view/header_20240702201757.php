...
require_once '../model/admin_db.php'; // Include the file with the is_valid_admin_login function
                    ...
                    <li class="nav-item">
                        <?php if ($username): ?>
                            <a class="nav-link" href="<?php echo $base_url; ?>account/index.php?action=logout">
                                <i class="fas fa-user"></i> Logout (<?php echo htmlspecialchars($username); ?>)
                            </a>
                        <?php else: ?>
